...
namespace APIVerve
{
    public class WeatherAPIClient
    {
        ...
        public WeatherAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public WeatherAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, weatherforecastQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(weatherforecastQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(weatherforecastQueryOptions options)
        {
